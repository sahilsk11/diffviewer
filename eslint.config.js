...
//
//   - Tuned to catch classes of mistakes that get past humans
//     (floating promises, misused promises, cyclic imports, dead
//     handlers) rather than style. Style is owned by Prettier.
...
export default defineConfig([
  globalIgnores(['dist', 'node_modules']),
  {
    ...
    rules: {
      // Hard structural cap. Combined with no-cycle, this is the
      // structural backbone that prevents 1000-line god components.
      'max-lines': ['error', { max: 700, skipBlankLines: true, skipComments: true }],

      // Bug-class rules. These catch real mistakes that get past code
      // review.
      ...
      // Direct fixes for habits we don't want to bring forward:
      // alert()-as-error-handling, ad-hoc console.log debug, ==.
      'no-alert': 'error',
